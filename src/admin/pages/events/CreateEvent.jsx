...
const BRANCH_API = `${API_BASE_URL}/api/branches`; // admin branch list
      ...
      <div className="space-y-6 max-w-3xl pb-10">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-gray-800 flex items-center gap-2">
            <CalendarDays size={26} className="text-green-700" />
            Schedule New Event
          </h1>
          <p className="text-sm text-gray-400 mt-0.5">Input details below to create an event at your designated branch/locality</p>
        </div>
        ...
        >
          <div className="space-y-1">
            ...
            <input
              ...
              name="title"
              required
              placeholder="e.g. Village Hydration Awareness Campaign"
          ...
          <div className="space-y-1">
            <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">Event Description *</label>
            <textarea
              name="description"
              required
              rows={4}
              placeholder="Outline event agenda, expected coordinators, and details..."
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1">
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">Venue / Location Link *</label>
              <input
                type="text"
                name="location"
                required
                placeholder="e.g., Primary School Hall Sector 2"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="space-y-1 col-span-1">
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">Max RSVP Capacity</label>
              <input
                type="number"
                name="capacity"
                min="0"
            ...
            <div className="space-y-1 col-span-1">
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">Branch office</label>
              <select
                name="branch"
            ...
            <div className="space-y-1 col-span-1">
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider">Launch status</label>
              <select
                name="status"
