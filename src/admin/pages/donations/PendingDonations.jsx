  ...
  return (
    <Layout>
      <div className="space-y-6 pb-10">
        ...
        {/* Title */}
        <div>
          <h1 className="text-3xl font-extrabold text-gray-800 tracking-tight">Pending Verification</h1>
          <p className="text-sm text-gray-400 font-semibold mt-1">Verify cheque deposits or bank transfers to clear donations</p>
        </div>
        ...
        <div className="rounded-3xl overflow-hidden bg-white border border-gray-100 shadow-xl">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-gray-400 space-y-3 font-semibold text-sm">
              <AlertCircle size={32} />
                ...
                <tbody className="divide-y divide-gray-100">
                  {donations.map(donation => (
                    <tr key={donation._id} className="hover:bg-gray-50/30 transition-colors">
                      ...
                      <td className="px-6 py-4 font-semibold text-gray-600 capitalize">{donation.paymentMethod.replace('_', ' ')}</td>
                      ...
                      <td className="px-6 py-4">
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 bg-green-800 text-white rounded-lg font-bold text-xs cursor-pointer border-0 hover:bg-green-700 disabled:opacity-50 transition-all shadow-sm active:scale-95"
                        >
