  ...
  return (
    <Layout>
      <div className="max-w-2xl space-y-6">
        <div>
          <h1 className="text-2xl font-extrabold text-gray-800">System Settings</h1>
          <p className="text-sm text-gray-400 mt-0.5">Manage your system configuration and preferences</p>
        </div>
